...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 13 mars 2024 à 20:00
...
(7, 'Iphone Pro Max', 2, '2024-03-07 22:52:32', 'je  vend mon iphone pro max ', 'image/annonce/Iphone Pro Max.png', 5, 300, 'Neuf', 1, 0, 0, 1709848352);
...
--
ALTER TABLE `favoris`
  MODIFY `idf` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
